...
public class stage_1 extends BaseGameActivity implements
	...
	private int number_of_blocks = 8;
	...
	//	mMainScene.attachChild(ball);
		...
		final Sprite face = new Sprite(centerX, centerY, this.mFaceTextureRegion_box);
